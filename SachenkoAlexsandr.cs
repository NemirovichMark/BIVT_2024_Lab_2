...
public class Program
{
    ...
    public (int, double) Task_2_11(int n)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            mark3 = double.Parse(Console.ReadLine());
            mark4 = double.Parse(Console.ReadLine());
            if (mark1 == 2 || mark2 == 2 || mark3 == 3 || mark4 == 2)
            {
                dvoichnik += 1;
            }
        ...
        // хот€бы 1 двойку получил - неуспевающий
        // end
    ...
    public double Task_2_12(double r, int type)
    {
        ...
        switch (type)
        {
            ...
            case 2:
                ...
                break;
            default:
                //Console.WriteLine("Ќеверный выбор");
                break;
        }
    ...
    public int Task_3_2(double r, double a, double b)
    {
        ...
        double x = 0, y = 0;
        // code here
        Console.WriteLine("¬ведите 777 чтобы остановить прграмму");
        while (true)
        {
